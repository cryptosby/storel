...
let posts = JSON.parse(localStorage.getItem('storelPosts')) || [
    {
        ...
        landingContent: {
            ...
            Superando las Excusas para Crecer en YouTube: Muchos aspiran a crecer en YouTube, pero las excusas se interponen. La clave no es la falta de ideas, sino la ausencia de un sistema.",
            features: [
