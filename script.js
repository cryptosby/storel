...
let posts = JSON.parse(localStorage.getItem('storelPosts')) || [
    {
        ...
        comments: [
            ...
            { id: 31, user: 'Alcalá Berta', userImage: 'https://placehold.co/30x30/fecaca/991b1b?text=AB', text: 'Mis videos pasaron de tener 50 vistas a miles. La estrategia de visibilidad que enseñan es completamente efectiva.', date: '2026-03-25T02:08:00Z', replies: [] }, // Comentario de hace ~4 meses
