...
let posts = JSON.parse(localStorage.getItem('storelPosts')) || [
    {
        ...
        comments: [
            ...
            { id: 45, user: 'Santa Zermeño Ochoa', userImage: 'https://i.postimg.cc/fRYff943/digital-product-marketplace-social-networks-45.jpg', text: 'Esta guía te enseña a darle a tu marca una visibilidad masiva en la plataforma con más tráfico del mundo.', date: '2026-05-04T21:29:00Z', replies: [] }, // Comentario de hace ~2 meses
            { id: 44, user: 'Matías Figueroa', userImage: 'https://i.postimg.cc/5yGSn5NP/digital-product-marketplace-social-networks-44.jpg', text: 'Promocionar mi negocio en YouTube Shorts me trajo clientes que realmente estaban buscando mis servicios. ¡Es oro puro!', date: '2026-05-03T00:17:00Z', replies: [] }, // Comentario de hace ~2 meses
            ...
            { id: 36, user: 'Isidra Echeverría', userImage: 'https://i.postimg.cc/MGy3HLZh/digital-product-marketplace-social-networks-36.jpg', text: 'Pude integrar mis productos de comercio electrónico a los Shorts de manera natural. ¡Las ventas se han disparad', date: '2026-04-09T06:07:00Z', replies: [] }, // Comentario de hace ~3 meses
